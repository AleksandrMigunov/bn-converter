...
class MyWin(QtGui.QMainWindow):
    ...
    def HG_converter(self, lang, addOrig):
        ...
        for line in f2:                         
            ...
            if (lang == "Ingush" or lang == "Avar"):
                ...
                txt = re.sub(r"(Υ|Ὑ|Ὓ|Ὕ|Ὗ)", r"ХӀуь", txt)
    ...
    def closeEvent(self, e):
        result = QtGui.QMessageBox.question(self, "Confirm Dialog",
                                                "Really quit?",
    ...
    def saveToFile_1(self):
        ...
        self.fileName, _ = QtGui.QFileDialog.getSaveFileName(self, "Save To File", "",
    ...
    def clearText_1(self):
        answer = QtGui.QMessageBox.question(self, "Clear Text", 
            "Do you want to clear the text?", QtGui.QMessageBox.No | QtGui.QMessageBox.Yes,
            QtGui.QMessageBox.Yes)
